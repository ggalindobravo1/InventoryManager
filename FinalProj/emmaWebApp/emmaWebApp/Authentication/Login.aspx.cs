...
namespace emmaWebApp.Authentication
{
    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            IdentityUser user = manager.Find(txtUser.Value.ToString(), passPass.Value.ToString());
            if (user == null)
            {
            ...
            else
            {
                ...
                Session["User"] = userIdentity.Name;
                Response.Redirect("~/Default.aspx?User=" + txtUser.Value.ToString());
            }
